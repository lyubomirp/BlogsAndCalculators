...
class IssueController extends Controller
{
    ...
    public function edit($id, Request $request)
    {
        ...
        return $this->render("issue/edit.html.twig", array('form' => $form->createView(), 'issue' => $issue));
    }
    ...
    public function delete($id, Request $request)
    {
        ...
        return $this->render("issue/delete.html.twig", array('issue' => $issue, 'form' => $form->createView()));
    }
}
